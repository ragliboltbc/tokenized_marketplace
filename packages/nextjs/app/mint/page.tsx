  ...
  return (
    <div className="max-w-xl mx-auto p-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <input name="assetType" placeholder="Asset Type (e.g. Car, House)" className="input input-bordered w-full" value={form.assetType} onChange={handleChange} required />
        <input name="legalId" placeholder="Legal ID (e.g. VIN)" className="input input-bordered w-full" value={form.legalId} onChange={handleChange} required />
        <input name="brand" placeholder="Brand" className="input input-bordered w-full" value={form.brand} onChange={handleChange} required />
